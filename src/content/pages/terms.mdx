...
seo:
  title: Terms of Service
  description: Henk Verlinde's terms of service
---
import Email from '../../components/Email.astro';

**Last updated on April 11, 2024**

_These terms of service ("Terms") apply to your access and use of the Henk Verlinde website (the "Service"). Please read them carefully._

## Accepting the Terms

If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing <Email address="support@henkverlinde.com" />.

## Changes to the Terms

We reserve the right to modify these Terms at any time. Whenever we make changes to these Terms, the changes are effective 2 days after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check Henk Verlinde for changes to these Terms.
...
Henk Verlinde makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
...
IN NO EVENT WILL HENK VERLINDE BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO HENK VERLINDE THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
...
These Terms constitute the entire agreement between you and Henk Verlinde regarding the use of the Service, superseding any prior agreements between you and Henk Verlinde relating to your use of the Service.

## Feedback

Please let us know what you think of the Service, these Terms and, in general, Henk Verlinde. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, Henk Verlinde, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.

## Questions & Contact Information

Questions or comments about the Service may be directed to us at the email address <Email address="support@henkverlinde.com" />.
