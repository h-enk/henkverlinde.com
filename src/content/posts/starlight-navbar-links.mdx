...
Enhancing the navigation of your [Starlight](https://starlight.astro.build/)-powered site is a great way to improve usability and guide users to important resources. In this guide, I'll walk you through how to dynamically add links to Starlight's navbar by creating a custom component and updating your configuration.
...
```txt title="astro.config.mjs" {13-15}
// @ts-check
